...
<div class="content">
    <div class="container-fluid py-4" style="background-color:#f9fafb; min-height:100vh;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 px-3">
            <h4 class="fw-bold text-dark">Dispositivos</h4>
                        ...
                        <div class="card bg-dark text-white shadow-sm dept-card h-100">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <?= htmlspecialchars($devi['id']) ?>
                                </span>
                                </div>

                                <!-- MIDDLE: info -->
                                <div class="mb-3">
                                    <div><strong>Total de afiliados:</strong> <?= htmlspecialchars($devi['deviceBiometricType']) ?></div>
                                </div>
